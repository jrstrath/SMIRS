<?php
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $sql = "SELECT location FROM farmer WHERE username = '$username' and password = '$password'";
        ...
        if($count == 1) {
           //Update Location
           $update_location = "UPDATE `farmer` SET `location`='$location' WHERE `username`= '$username'";
           $update = mysqli_query($db, $update_location);
            ...
            <div class="col-lg-4 mx-auto">
              ...
              <div class="auto-form-wrapper">
                <form action="" method="POST">
                  ...
                  <div class="form-group">
                    <input type="submit" class="btn btn-primary submit-btn btn-block" value = "Change">
                  </div>
                </form>
              </div>
